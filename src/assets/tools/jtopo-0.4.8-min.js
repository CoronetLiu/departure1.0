    ...
    function b(c) {
        this.initialize = function (c) {
            ...
            if (null != this.alarm && "" != this.alarm) {
                ...
                var d = a.measureText(this.alarm).width + 6, e = a.measureText("ç”°").width + 6, f = this.width / 2 - d / 2, g = -this.height / 2 - e - 8;
    ...
    function b() {
        ...
        return b.radius = 150, b.colors = ["#3666B0", "#2CA8E0", "#77D1F6"], b.datas = [.3, .3, .4], b.titles = ["A", "B", "C"], b.paint = function (a) {
            ...
            for (var e = 0, f = 0; f < this.datas.length; f++) {
                ...
                var h = this.titles[f] + ": " + (100 * this.datas[f]).toFixed(2) + "%", i = a.measureText(h).width, j = (a.measureText("ç”°").width, (e + e + g) / 2), k = this.radius * Math.cos(j), l = this.radius * Math.sin(j);
