        ...
        layui.use('table', function(){
            ...
            table.render({
                ...
                cols: [[ //标题栏
                    ...
                    {field: 'dataCenter', title: '数据中心', sort:true, width: 150,style:"text-align:center;"},
                    {field: 'dataRoom', title: '机房', width: 150,style:"text-align:center;"},
                    {field: 'dataRowCol', title: '行/列', width: 150,style:"text-align:center;"},
                    {field: 'dataCab', title: '机柜', width: 150,style:"text-align:center;",toolbar:"#barId"},
                    {field: 'Unum', title: 'U数', width: 150,style:"text-align:center;"},
                    {field: 'deviceNum', title: '下属设备', width: 150,style:"text-align:center;"},
